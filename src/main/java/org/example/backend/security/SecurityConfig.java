        ...
        httpSecurity.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(
                        auth -> auth
                                ...
                                .requestMatchers("/headerSection/home").permitAll()
                                .requestMatchers("/footerSection/").permitAll()
                                .requestMatchers("/footerSection/get").permitAll()
                                .requestMatchers("/aboutSection").permitAll()
                                .requestMatchers("/aboutSection/home").permitAll()
