...
public interface AboutService {
    ...
    void aboutPostAndUpdate(MultipartFile img, MultipartFile videoImg, MultipartFile video, String description1Uz,
                            String description1Ru, String description1En,
                            String description2Uz, String description2Ru, String description2En,
                            Integer successfulStudents, Double averageScore, Integer yearsExperience,
                            Integer successRate);

    void deleteAbout(UUID id);

    AboutSectionHomeResDto getAboutForHome(String lang);
}
